...
public class Admin {
	...
	@Path("/database")
	@Produces(MediaType.APPLICATION_JSON)
	public String Database(@Context HttpServletRequest request) throws ParseException, InstantiationException,
	...
	public String Columns(@Context HttpServletRequest request, @DefaultValue("") @QueryParam("tableName") String table,
			@DefaultValue("") @QueryParam("dbName") String db) throws ParseException, InstantiationException,
			IllegalAccessException, ClassNotFoundException, SQLException {
